<template>
  <div>
    <v-chart :force-fit="true" :height="600" :data-pre="dataPre" :data-view="'edges'" :data="data" :data-mapping="dataMapping" :scale="scale">
      <v-sankey :v-style="{ curvature: 0.5 }" :color="'#333'" :opacity="0.1" :tooltip="'value'" />
      <v-view :view-id="'3'" :data-view="'nodes'" :data-mapping="viewDataMapping">
